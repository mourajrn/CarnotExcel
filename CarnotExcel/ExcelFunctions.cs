...
namespace CarnotExcel
{
    public class ExcelFunctions : IExcelAddIn
    {
        ...
        [ExcelFunction(Name = "MAIÚSCULA.CARNOT", Description = "Função para colocar a primeira letra de cada palavra em maiúsculo ignorando algumas palavras")]
        public static string capitalize([ExcelArgument(Name = "Texto", Description = "Texto para aplicar a função")] string name)
        {
            ...
            {
                "a", "o", "as", "os", "de", "de", "das", "do", "da", "e", "ou", "para", "por", "no", "na", "nos", "nas"
            };
